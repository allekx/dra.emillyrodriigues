...
export const services: Service[] = [
  {
    ...
    importantInfo: [],
    image: "/images/services/harmonizacao-facial-v2.jpg",
    featured: true,
  ...
  },
  {
    ...
    indicatedFor: defaultIndicatedFor,
    importantInfo: [],
    image: "/images/services/botox-v2.jpg",
    featured: true,
    benefits: defaultBenefits,
  ...
  },
  {
    ...
    indicatedFor: defaultIndicatedFor,
    importantInfo: [],
    image: "/images/services/tratamentos-corporais.jpg",
    featured: true,
    benefits: defaultBenefits,
  ...
  },
  {
    ...
    indicatedFor: defaultIndicatedFor,
    importantInfo: [],
    image: "/images/services/procedimentos-esteticos.jpg",
    featured: false,
    benefits: defaultBenefits,
