  ...
  if (layout === "editorial") {
    return (
      <article>
        <Link
          href={href}
          className="card-interactive group grid min-h-[8rem] min-w-0 grid-cols-[40%_1fr] overflow-hidden rounded-lg border border-border bg-surface shadow-soft no-underline hover:border-gold-soft hover:shadow-lift focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold"
          aria-label={label}
        >
          <div className="relative min-h-[8rem] overflow-hidden bg-sand">
            <MediaImage
              src={service.image}
