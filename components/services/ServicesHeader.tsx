...
export function ServicesHeader() {
  return (
    <header className="pt-6 sm:pt-10">
      <NavBack href={routes.bio} className="text-taupe">
        Voltar à Bio
      </NavBack>

      <div className="catalog-intro mt-7 sm:mt-10">
        ...
        <h1 className="mt-2.5 text-[1.7rem] leading-[1.1] min-[375px]:text-[1.85rem] sm:text-[2rem]">
          {servicesPage.title}
        </h1>
